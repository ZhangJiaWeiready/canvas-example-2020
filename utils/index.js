var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      var start_time = "1549036800000";
      var days = parseInt((Date.now() - start_time) / 1000 / 3600 / 24) + 1;
      // S.UI.simulate('熊猫宝宝|今天是我们|在一起|'+days+'天|指缝太宽|时光太瘦|感恩相遇|余生是你|#rectangle|#countdown 3|我爱你');
      S.UI.simulate('zhangjiawei|zhangjiawei|zhangjiawei|' + days + '天|zhangjiawei|zhangjiawei|zhangjiawei|zhangjiawei|#countdown 3|zhangjiawei');
    }
